        ...
        <div class="p-7">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
              <div class="w-full sm:w-1/2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-normal text-black focus:border-primary-500 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary-500"
                    type="text"
                    name="fullName"
                    id="fullName"
              ...
              <div class="w-full sm:w-1/2">
                ...
                <input
                  ...
                  class="w-full rounded border border-stroke bg-gray py-3 px-4.5 font-normal text-black focus:border-primary-500 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary-500"
                  type="text"
                  name="phoneNumber"
                  id="phoneNumber"
            ...
            <div class="flex justify-end gap-4.5">
              ...
              <button
                class="flex justify-center rounded bg-primary-500 py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                type="submit"
              >
                Save
              </button>
      ...
      >
        ...
        <div class="p-7">
          <form @submit.prevent="handlePhotoSubmit">
            ...
            <div class="mb-4 flex items-center gap-3">
              ...
              <div>
                ...
                <span class="flex gap-2.5">
                  <button class="text-sm font-medium hover:text-primary-500" @click="deletePhoto">
                    Delete
                  </button>
                  <button class="text-sm font-medium hover:text-primary-500" @click="updatePhoto">
                    Update
                  </button>
                </span>
              </div>
            ...
            <div
              id="FileUpload"
              class="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-primary-500 bg-gray py-4 px-4 dark:bg-meta-4 sm:py-7.5"
            >
              <input
                type="file"
                accept="image/*"
