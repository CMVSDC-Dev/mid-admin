  ...
  <div>
    ...
    <div class="relative z-20 bg-white dark:bg-form-input">
      ...
      <select
        ...
        class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-12 outline-none transition focus:border-primary-500 active:border-primary-500 dark:border-form-strokedark dark:bg-form-input"
      >
