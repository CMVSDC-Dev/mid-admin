        ...
        <div class="relative z-20 inline-block w-full">
          <div class="relative flex flex-col items-center">
            <div @click="open" class="w-full">
              <div
                class="mb-2 flex rounded border border-stroke py-2 pl-3 pr-3 outline-none transition focus:border-primary-500 active:border-primary-500 dark:border-form-strokedark dark:bg-form-input"
              >
                  ...
                  <template v-for="index in selected" :key="index">
                    ...
                    >
                      ...
                      <div class="flex flex-auto flex-row-reverse">
                        <div @click="remove(index)" class="cursor-pointer pl-2 hover:text-danger-500">
                          <svg
                            class="fill-current"
                            role="button"
                            width="12"
                ...
                <div class="flex w-full flex-col">
                  <div v-for="(option, index) in options" :key="index">
                    <div
                      ...
                      class="w-full cursor-pointer rounded-t border-b border-stroke hover:bg-primary-500/5 dark:border-form-strokedark"
                    >
                      <div
                        :class="[
                          'relative flex w-full items-center border-l-2 border-transparent p-2 pl-2',
                          option.selected ? 'border-primary-500' : ''
                        ]"
                      >
