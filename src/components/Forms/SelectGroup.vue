<template>
  <div :class="`${horizontal ? 'flex w-full' : ''}  ${merged ? 'merged' : ''} ${customClasses}`">
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      <select
        class="relative z-21 w-full appearance-none rounded border border-stroke bg-transparent py-2 px-5 outline-none transition focus:border-primary-500 active:border-primary-500 dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary-500"
