...
<template>
  ...
  >
    <div class="grid grid-cols-7 rounded-t-sm bg-primary-500 text-white">
    ...
    <div class="grid grid-cols-7">
      ...
      >
        ...
        >
          ...
          >
            <span class="group-hover:text-primary-500 md:hidden"> More </span>
            <div
              class="event invisible absolute left-2 z-99 mb-1 flex w-[200%] flex-col rounded-sm border-l-[3px] border-primary-500 bg-gray px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-meta-4 md:visible md:w-[190%] md:opacity-100"
            >
